...
<p class="subtitle">Last updated: February 27, 2026</p>
...
## Data the Organization Does Not Collect
...
These third parties may temporarily log technical information such as:
...
- The Organization will retain such communications only as long as reasonably necessary and will delete them thereafter.
...
If a visitor believes the Organization holds personal data about them (for example, through prior email correspondence), the visitor may contact the Organization at **[info.roboskyline@gmail.com](mailto:info.roboskyline@gmail.com)** to request:
...
The most recent version of this policy is always available at **[{{ site.url }}{{ site.baseurl }}/privacy-policy/]({{ site.url }}{{ site.baseurl }}/privacy-policy/)**.
